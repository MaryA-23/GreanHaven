...
return [
    ...
    'database' => [
        ...
        'tenant-connection' => 'mysql',
        'tenant_migration_path' => database_path('migrations/tenant'),
        /**
         * The tenancy package is able to automatically set up the database
         * connection for the tenant. This is done by setting the default
         * connection to the tenant connection.
         *
         * @info set to false to disable.
         */
        'auto-setup-tenant-connection' => true,

        /**
         * The tenancy package is able to automatically set up the database
         * connection for the system. This is done by setting the default
         * connection to the system connection.
         *
         * @info set to false to disable.
         */
        'auto-setup-system-connection' => true,
    ],
    /**
